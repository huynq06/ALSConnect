...
import { View,StyleSheet,TouchableOpacity,Image,Animated,FlatList } from "react-native";
          ...
          {locationTabs.map((item,index)=>{
              return(
                  ...
                  >
                      ...
                      >
                          <Text gray body3>{item.title}</Text>
                      </View>
                  </TouchableOpacity>
              )
              })}
...
const CallTruckScreen = ({navigation,route})=>{
                              ...
                              renderItem={({item,index})=>{
                                  return(
                                      ...
                                      >
                                          ...
                                          >
                                               <Text style={{marginLeft:SIZES.radius}} body3 gray>{item.BSX}</Text>
                                          </View>
                                          ...
                                          >
                                               <Text style={{marginLeft:SIZES.radius}} body3 gray>{item.Created}</Text>
                                          </View>
  ...
  function renderTitle(){
    return(
      ...
      >
        <Text gray body3>Danh sách xe được gọi</Text>
      </View>
    )
  }
    return(
